...
// Setting top to 0 initialize the stack.
	...
	top=0; //In the outputStack method, we start to print from the top so if we make top 0, then it won't print anything.
...
// top method sometimes called as the peek() method. The stack must be not empty. Returns the top element of the stack.		
	...
	public void copyStack(Stack newStack) { //if we say s.copyStack(x), it will copy x into s.
